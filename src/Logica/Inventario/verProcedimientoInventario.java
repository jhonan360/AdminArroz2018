    ...
    public void buscar() {
        ...
        if (VerProcedI.chProcedimiento.isSelected() == true && VerProcedI.chBateria.isSelected() == true && VerProcedI.chSilo.isSelected() == true && VerProcedI.chFecha.isSelected() == true) {
            if (!procedimiento.equals("") && !bateria.equals("") && !silo.equals("") && !fechaI.equals("") && !fechaF.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE idProcedimiento= '" + procedimiento + "' AND bateria.nombre= '" + bateria + "' AND silos.numero = '" + silo + "' AND fecha >= '" + fechaI + "' AND fecha<= '" + fechaF + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!procedimiento.equals("") && !bateria.equals("") && !silo.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE idProcedimiento= '" + procedimiento + "' AND bateria.nombre= '" + bateria + "' AND silos.numero = '" + silo + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!procedimiento.equals("") && !bateria.equals("") && !fechaI.equals("") && !fechaF.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE idProcedimiento= '" + procedimiento + "' AND bateria.nombre= '" + bateria + "' AND fecha >= '" + fechaI + "' AND fecha<= '" + fechaF + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!bateria.equals("") && !silo.equals("") && !fechaI.equals("") && !fechaF.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE bateria.nombre= '" + bateria + "' AND silos.numero = '" + silo + "' AND fecha >= '" + fechaI + "' AND fecha<= '" + fechaF + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!procedimiento.equals("") && !bateria.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE idProcedimiento= '" + procedimiento + "' AND bateria.nombre= '" + bateria + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!procedimiento.equals("") && !fechaI.equals("") && !fechaF.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE idProcedimiento= '" + procedimiento + "' AND fecha >= '" + fechaI + "' AND fecha<= '" + fechaF + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!bateria.equals("") && !silo.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE bateria.nombre= '" + bateria + "' AND silos.numero = '" + silo + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!bateria.equals("") && !fechaI.equals("") && !fechaF.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE bateria.nombre= '" + bateria + "' AND fecha >= '" + fechaI + "' AND fecha<= '" + fechaF + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!procedimiento.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE idProcedimiento= '" + procedimiento + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!bateria.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE bateria.nombre= '" + bateria + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
            ...
            if (!fechaI.equals("") && !fechaF.equals("")) {
                tbl.llenarTabla(VerProcedI.tblVerProcedI, modelVerProcedI, columnProced.length, "SELECT idProcedimiento,bateria.nombre,secadora.nombre,silos.numero,tiqueteensilos.kilos,fecha,hora,tipoAlmacenamiento,observacion FROM procedimiento,silos,bateria,secadora,tiqueteensilos WHERE fecha >= '" + fechaI + "' AND fecha<= '" + fechaF + "' AND procedimiento.estado='finalizado' AND procedimiento.idSilos=silos.idSilos AND silos.idSilos=tiqueteensilos.idSilos AND silos.idSecadora=secadora.idSecadora AND secadora.idBateria=bateria.idBateria GROUP by procedimiento.idProcedimiento ORDER BY procedimiento.idProcedimiento DESC");
                tbl.alinearHeaderTable(VerProcedI.tblVerProcedI, alineaHeaderProced);
                tbl.alinearCamposTable(VerProcedI.tblVerProcedI, alineaCampoProced);
                formatoTablaProced();
            } else {
