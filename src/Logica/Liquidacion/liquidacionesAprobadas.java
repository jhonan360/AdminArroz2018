...
public class liquidacionesAprobadas {
    ...
    public static String columLiquidaciones[] = new String[]{"N° Liq", "Fecha", "Cedula", "Agricultor", "Neto Pagar"};
    public static String alinearHeaderLiq[] = new String[]{"30", "60", "70", "90", "80"};
    public static String alinearCamposLiq[] = new String[]{"center", "center", "right", "left", "right"};
    public static String columDetalle[] = new String[]{"N° Tiq", "Fecha", "Kg Brutos", "Hum", "Imp", "% H Castigo", "% I Castigo", "Peso Compra", "Valor Kg", "Valor Total"};
    ...
    public void limpiarCampos() {
        ...
        LiqAprobadas.lblKilosDescuent.setText("");
    }
