...
public class vehiculo {
    ...
    public void crearModelo() {
        ...
        tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
        tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
    }
    ...
    public void buscar() {
        ...
        if (Vhc.chPlaca.isSelected() == true && Vhc.chModelo.isSelected() == true && Vhc.chMarca.isSelected() == true) {
            if (!placa.equals("") && !modelo.equals("") && !marca.equals("")) {
                tbl.llenarTabla(Vhc.jTable1, modelVhc, columnas.length, "SELECT idVehiculo,placa,marca.marca,modelo,color FROM vehiculo,marca WHERE vehiculo.placa like '%" + placa + "%' and vehiculo.modelo like '%" + modelo + "%' and marca.marca like '%" + marca + "%' and vehiculo.idMarca=marca.idMarca");
                tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
                tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
            } else {
            ...
            if (!placa.equals("") && !modelo.equals("")) {
                tbl.llenarTabla(Vhc.jTable1, modelVhc, columnas.length, "SELECT idVehiculo,placa,marca.marca,modelo,color FROM vehiculo,marca WHERE vehiculo.placa like '%" + placa + "%' and vehiculo.modelo like '%" + modelo + "%'and vehiculo.idMarca=marca.idMarca");
                tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
                tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            ...
            if (!placa.equals("") && !marca.equals("")) {
                tbl.llenarTabla(Vhc.jTable1, modelVhc, columnas.length, "SELECT idVehiculo,placa,marca.marca,modelo,color FROM vehiculo,marca WHERE vehiculo.placa like '%" + placa + "%' and marca.marca like '%" + marca + "%'and vehiculo.idMarca=marca.idMarca");
                tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
                tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            ...
            if (!modelo.equals("") && !marca.equals("")) {
                tbl.llenarTabla(Vhc.jTable1, modelVhc, columnas.length, "SELECT idVehiculo,placa,marca.marca,modelo,color FROM vehiculo,marca WHERE vehiculo.modelo like '%" + modelo + "%' and marca.marca like '%" + marca + "%'and vehiculo.idMarca=marca.idMarca");
                tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
                tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            ...
            if (!placa.equals("")) {
                tbl.llenarTabla(Vhc.jTable1, modelVhc, columnas.length, "SELECT idVehiculo,placa,marca.marca,modelo,color FROM vehiculo,marca WHERE vehiculo.placa like '%" + placa + "%'and vehiculo.idMarca=marca.idMarca");
                tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
                tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            ...
            if (!modelo.equals("")) {
                tbl.llenarTabla(Vhc.jTable1, modelVhc, columnas.length, "SELECT idVehiculo,placa,marca.marca,modelo,color FROM vehiculo,marca WHERE vehiculo.modelo like '%" + modelo + "%'and vehiculo.idMarca=marca.idMarca");
                tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
                tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            ...
            if (!marca.equals("")) {
                tbl.llenarTabla(Vhc.jTable1, modelVhc, columnas.length, "SELECT idVehiculo,placa,marca.marca,modelo,color FROM vehiculo,marca WHERE marca.marca like '%" + marca + "%'and vehiculo.idMarca=marca.idMarca");
                tbl.alinearHeaderTable(Vhc.jTable1, headerColumnas);
                tbl.alinearCamposTable(Vhc.jTable1, camposColumnas);
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
