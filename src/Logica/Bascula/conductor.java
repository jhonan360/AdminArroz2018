...
public class conductor {
    ...
    public void insertar(String cedula, String nombres, String apellidos, String telefono, String ciudad, String direccion) {
        try {
            ...
            ext.logs("INSERT","INSERT INTO personalexterno (cedula,nombres,apellidos,telefono,Direccion,idMunicipio,tipo) VALUES ('" + cedula + "','" + nombres + "','" + apellidos + "','" + telefono + "','" + direccion + "','" + ciudad + "','conductor')");
