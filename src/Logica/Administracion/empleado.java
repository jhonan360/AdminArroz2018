...
public class empleado {
    ...
    public String columnas[] = new String[]{"cedula", "nombres", "apellidos", "ciudad", "direccion", "telefono", "cargo"};
    public tablas tbl;
    public int idCargo;
    ...
    public void crearModelo() {
        ...
        tbl = new tablas();
        tbl.llenarTabla(Emp.jTable1, modeloemp, columnas.length, "SELECT ccEmpleado,nombres,apellidos,municipios.Nombre,direccion,telefono,cargo.nombre FROM empleado,cargo,municipios WHERE empleado.idCargo = cargo.idCargo and empleado.idMunicipio=municipios.idMunicipio");
    ...
    public void tablas_campos() {
        ...
        Emp.txtCedula.setText(Emp.jTable1.getValueAt(rec, 0).toString());
        Emp.txtNombres.setText(Emp.jTable1.getValueAt(rec, 1).toString());
        Emp.txtApellidos.setText(Emp.jTable1.getValueAt(rec, 2).toString());
        Emp.cmbDepartamento.setSelectedItem(getDepartamento(Emp.jTable1.getValueAt(rec, 0).toString()));
        Emp.cmbMunicipio.setSelectedItem(Emp.jTable1.getValueAt(rec, 3).toString());
        Emp.txtDireccion.setText(Emp.jTable1.getValueAt(rec, 4).toString());
        Emp.txtTelefono.setText(Emp.jTable1.getValueAt(rec, 5).toString());
        Emp.cmbCargo.setSelectedItem(Emp.jTable1.getValueAt(rec, 6).toString());
    }
    ...
    public void buscar() {
        ...
        if (Emp.chCedula.isSelected() == true && Emp.chApellidos.isSelected() == true && Emp.chCiudad.isSelected() == true && Emp.chCargo.isSelected() == true) {
            ...
            if (!cedula.equals("") && !cargo.equals("")) {
             ...
             if (!cedula.equals("")) {
                 tbl.llenarTabla(Emp.jTable1, modeloemp, columnas.length, "SELECT ccEmpleado,nombres,apellidos,municipios.Nombre,direccion,telefono,cargo.nombre FROM empleado,cargo,municipios WHERE empleado.ccEmpleado like '%" + cedula + "%' and empleado.idCargo = cargo.idCargo and empleado.idMunicipio=municipios.idMunicipio ");
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            }
        } else if (Emp.chApellidos.isSelected() == true) {
              if (!apellidos.equals("")) {
                  tbl.llenarTabla(Emp.jTable1, modeloemp, columnas.length, "SELECT ccEmpleado,nombres,apellidos,municipios.Nombre,direccion,telefono,cargo.nombre FROM empleado,cargo,municipios WHERE empleado.apellidos like '%" + apellidos  + "%' and empleado.idCargo = cargo.idCargo and empleado.idMunicipio=municipios.idMunicipio ");
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            }
        } else if (Emp.chCiudad.isSelected() == true) {
              if (!ciudad.equals("")) {
                  tbl.llenarTabla(Emp.jTable1, modeloemp, columnas.length, "SELECT ccEmpleado,nombres,apellidos,municipios.Nombre,direccion,telefono,cargo.nombre FROM empleado,cargo,municipios WHERE municipios.Nombre like '" +ciudad + "' and empleado.idCargo = cargo.idCargo and empleado.idMunicipio=municipios.idMunicipio ");
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            }
        } else if (Emp.chCargo.isSelected() == true) {
              if (!cargo.equals("")) {
                  tbl.llenarTabla(Emp.jTable1, modeloemp, columnas.length, "SELECT ccEmpleado,nombres,apellidos,municipios.Nombre,direccion,telefono,cargo.nombre FROM empleado,cargo,municipios WHERE cargo.nombre like '%" + cargo + "%' and empleado.idCargo = cargo.idCargo and empleado.idMunicipio=municipios.idMunicipio ");
            } else {
                JOptionPane.showMessageDialog(null, "Uno de los campos que selecciono para la busqueda esta vacio");
            }
        } else {
